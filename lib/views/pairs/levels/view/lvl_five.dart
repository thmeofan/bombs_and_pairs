...
class PairLvlFive extends StatefulWidget {
  const PairLvlFive({super.key});

  @override
  _PairLvlFiveState createState() => _PairLvlFiveState();
}

class _PairLvlFiveState extends State<PairLvlFive> {
  ...
  void _initGame() {
    setState(() {
      List<String> halfGameIcons = List<String>.from(_availableIcons)
        ..shuffle();
      halfGameIcons = halfGameIcons.take(6).toList();
