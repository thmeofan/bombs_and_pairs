...
class PairLvlThree extends StatefulWidget {
  const PairLvlThree({super.key});

  @override
  _PairLvlThreeState createState() => _PairLvlThreeState();
}

class _PairLvlThreeState extends State<PairLvlThree> {
  ...
  void _initGame() {
    setState(() {
      List<String> halfGameIcons = List<String>.from(_availableIcons)
        ..shuffle();
      halfGameIcons = halfGameIcons.take(4).toList();
