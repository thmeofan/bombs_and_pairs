...
class BombLvlTwo extends StatefulWidget {
  const BombLvlTwo({super.key});

  @override
  _BombLvlTwoState createState() => _BombLvlTwoState();
}

class _BombLvlTwoState extends State<BombLvlTwo> {
  ...
  void _initGame() {
    setState(() {
      _gameIcons = List<String?>.filled(6, null);
