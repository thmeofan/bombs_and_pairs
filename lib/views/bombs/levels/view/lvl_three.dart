...
class BombLvlThree extends StatefulWidget {
  const BombLvlThree({super.key});

  @override
  _BombLvlThreeState createState() => _BombLvlThreeState();
}

class _BombLvlThreeState extends State<BombLvlThree> {
  ...
  void _initGame() {
    setState(() {
      _gameIcons = List<String?>.filled(8, null);
